...
export const INPUT_CLASS =
  'w-full px-3 py-2 text-sm rounded-xl border border-earth-200 dark:border-earth-600 ' +
...
export const BTN_PRIMARY =
  'flex-1 py-2.5 text-sm font-medium text-white bg-earth-500 hover:bg-earth-600 ' +
  'disabled:opacity-60 rounded-xl transition-colors'

export const BTN_SECONDARY =
  'flex-1 py-2.5 text-sm font-medium text-earth-600 dark:text-earth-400 ' +
